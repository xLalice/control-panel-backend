...
export const uploadDocument = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const category = await documentService.getCategoryById(parsedCategoryId);
    if (!category) {
    ...
    const document = await documentService.uploadDocument({
      ...
      uploadedById: req.body.userId || 'system' // You may need to get this from your auth middleware
    });
